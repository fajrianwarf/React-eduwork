...
export default class NewsApiClass extends Component {    
    ...
    getNews = async () => {
        try {
            let response = await axios.get(`https://newsapi.org/v2/top-headlines?q=${this.state.news}&country=us&category=business&apiKey=8368e4459d25495280471dc2f610a8bb`)
